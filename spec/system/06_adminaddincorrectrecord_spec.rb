...
require 'json'
# Тест проверяет сценарий попытки добавления НЕкорректного объявления (лота) админом
describe 'adminaddnewrecord' do
  ...
  it 'incorrect_adminaddnewrecord' do
    ...
    @driver.find_element(:name, 'commit').click
    # Проверяем, что запись не создалась, так некоторые поля не соотв. валидации
